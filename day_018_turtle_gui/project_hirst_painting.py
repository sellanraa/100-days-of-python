...
import turtle as t
import random
# Note that colorgram required being in the same folder as the .venv, so I had to pull day_018 files out of the folder to grab the RGB list.
# import colorgram
...
# REQ: 10 x 10, dot size 20, spaced by 50
timmy = t.Turtle()
timmy.speed(10)
t.colormode(255)
timmy.shape("turtle")
